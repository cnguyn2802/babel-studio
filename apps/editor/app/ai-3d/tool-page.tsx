...
const STARTER_TEMPLATES: Array<{
  ...
  },
  {
    ...
    shellClass: 'hover:border-amber-200 hover:bg-amber-50/45',
  },
  {
    id: 'dining-room',
    title: 'Dining room',
    prompt:
      'Use starter template dining-room. Create a dining room with local assetIds: dining-table, dining-chair, rectangular-carpet, indoor-plant.',
    icon: Utensils,
    iconClass: 'bg-cyan-50 text-cyan-600',
    shellClass: 'hover:border-cyan-200 hover:bg-cyan-50/50',
  },
]
